...
#                     outdir      = "/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562_whole_Genome",
...
#                     )
basealigncount(
               inputfile  ="/nfs/th_group/hk3/UW_DNaseI_HS/K562/wgEncodeUwDnaseK562AlnRep1.bed",
               outputfile = "/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562_whole_Genome/wgEncodeUwDnaseK562AlnRep1_0.05.basecount",
               extension  = 150,
               filetype   ="bed",
               twoBitFile="/nfs/th_group/hk3/Human_Genome_Build/hg19.2bit"
               )
zinba(
      align="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562_whole_Genome",
      numProc=5,
      threshold=0.05, #FDR threshold the default is 0.05 
      seq= "/nfs/th_group/hk3/UW_DNaseI_HS/K562/wgEncodeUwDnaseK562AlnRep1.bed",
      basecountfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562_whole_Genome/wgEncodeUwDnaseK562AlnRep1_0.05.basecount",
      filetype="bed",
      #outfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562/ZINBA_OUT_3_FDR_0.75",
      outfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562_whole_Genome/ZINBA_OUT_FDR_0.05",
