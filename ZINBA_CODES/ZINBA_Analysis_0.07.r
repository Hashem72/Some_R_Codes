4### for more information about insalling and running ZINBA look at: https://code.google.com/p/zinba/wiki/UsingZINBA
...
basealigncount(
               ...
               outputfile = "/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/Helas3/wgEncodeUwDnaseHelas3AlnRep1_chr22_0.07.basecount",
               extension  = 150,
               filetype   ="bed",
               twoBitFile="/nfs/th_group/hk3/Human_Genome_Build/hg19.2bit"
               )
zinba(
      ...
      numProc=5,
      threshold=0.07, #FDR threshold the default is 0.05 
      seq= "/nfs/th_group/hk3/Hotspot_vs_F_Seq/UW/Helas3/wgEncodeUwDnaseHelas3AlnRep1_chr22.bed",
      basecountfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/Helas3/wgEncodeUwDnaseHelas3AlnRep1_chr22_0.07.basecount",
      filetype="bed",
      #outfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562/ZINBA_OUT_3_FDR_0.75",
      outfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/Helas3/ZINBA_OUT_FDR_0.07",
