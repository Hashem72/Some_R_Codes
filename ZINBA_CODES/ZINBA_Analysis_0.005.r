...
# bsub -q long -o zinba_0.005_%J.output -e zinba_0.005_%J.err -M8000000 -R"select[mem>8000] rusage[mem=8000]" /software/bin/R-2.15 CMD BATCH ZINBA_Analysis.r
library(zinba)
...
#                     )
basealigncount(
               inputfile  ="/nfs/th_group/hk3/Hotspot_vs_F_Seq/UW/K562/wgEncodeUwDnaseK562AlnRep1_chr22.bed",
               outputfile = "/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562/wgEncodeUwDnaseK562AlnRep1_chr22_0.005.basecount",
               extension  = 150,
               filetype   ="bed",
               twoBitFile="/nfs/th_group/hk3/Human_Genome_Build/hg19.2bit"
               )
zinba(
      ...
      numProc=5,
      threshold=0.005, #FDR threshold the default is 0.05 
      seq= "/nfs/th_group/hk3/Hotspot_vs_F_Seq/UW/K562/wgEncodeUwDnaseK562AlnRep1_chr22.bed",
      basecountfile="/nfs/th_group/hk3/ZINBA_ANALYSIS/UW/K562/wgEncodeUwDnaseK562AlnRep1_chr22_0.005.basecount",
      filetype="bed",
