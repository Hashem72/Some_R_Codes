...
Encod.hotspot.H1hesc   <- "/nfs/th_group/hk3/UW_DNaseI_HS/H1hesc/wgEncodeUwDnaseH1hescHotspotsRep1.bed"
group.A.hotspot.H1hesc <-  "/nfs/th_group/hk3/Hotspot_Analysis/H1hesc/file_A_modified_sorted.bed-both-passes/group_A_without_track_line.wig"
group.B.hotspot.H1hesc <- "/nfs/th_group/hk3/Hotspot_Analysis/H1hesc/file_B_modified_sorted.bed-both-passes/group_B_without_track_line.wg"
Bed.Files <- c(Encod.hotspot.H1hesc,group.A.hotspot.H1hesc,group.B.hotspot.H1hesc)
VENNDIAGRAM(Bed.Files,Formats,FALSE,TRUE)


#Gm12878 without filtering short hotspots
Encod.hotspot.Gm12878 <- "/nfs/th_group/hk3/UW_DNaseI_HS/Gm12878/wgEncodeUwDnaseGm12878HotspotsRep1.bed"
group.A.hotspot.Gm12878 <- "/nfs/th_group/hk3/Hotspot_Analysis/Gm12878/file_A_modified_sorted.bed-both-passes/file_A_modified_sorted.bed.hotspot.twopass.zscore_without_tack_line.wig" 
group.B.hotspot.Gm12878 <- "/nfs/th_group/hk3/Hotspot_Analysis/Gm12878/file_B_modified_sorted.bed-both-passes/file_B_modified_sorted.bed.hotspot.twopass.zscore_without_tack_line.wig"
Gm12878.Bed.Files <- c(Encod.hotspot.Gm12878,group.A.hotspot.Gm12878,group.B.hotspot.Gm12878)
VENNDIAGRAM(Gm12878.Bed.Files,Formats,FALSE,TRUE)

#K562 without filtering short hotspots
Encod.hotspot.K562  <- "/nfs/th_group/hk3/UW_DNaseI_HS/K562/wgEncodeUwDnaseK562HotspotsRep1.bed"
group.A.hotspot.K562 <- "/nfs/th_group/hk3/Hotspot_Analysis/K562/file_A_modified_sorted.bed-both-passes/file_A_modified_sorted.bed.hotspot.twopass.zscore_without_tack_line.wig"
group.B.hotspot.K562 <- "/nfs/th_group/hk3/Hotspot_Analysis/K562/file_B_modified_sorted.bed-both-passes/file_B_modified_sorted.bed.hotspot.twopass.zscore_without_tack_line.wig"
K562.Bed.Files <-  c(Encod.hotspot.K562,group.A.hotspot.K562,group.B.hotspot.K562)
VENNDIAGRAM(K562.Bed.Files,Formats,FALSE,TRUE)
...
VENNDIAGRAM <- function(vectorOfThreeFiles,vectorOfThreeFileFormats,getData,percentageMode=FALSE,lengthThreshold =0){
  ...
  features.from.first.file  <- GET.VECTOR.OF.FEATURES(first.matrix,vectorOfThreeFileFormats[1] )
  ...
  features.from.second.file <- GET.VECTOR.OF.FEATURES(second.matrix,vectorOfThreeFileFormats[2] )
  ...
  features.from.third.file  <- GET.VECTOR.OF.FEATURES(third.matrix,vectorOfThreeFileFormats[3] )
